defmodule TrialGroupWeb.AdminResetPasswordLive do
  ...
  def handle_event("reset_password", %{"admin" => admin_params}, socket) do
    case Administration.reset_admin_password(socket.assigns.admin, admin_params) do
      {:ok, _} ->
        {:noreply,
         socket
  ...
  def handle_event("validate", %{"admin" => admin_params}, socket) do
    changeset = Administration.change_admin_password(socket.assigns.admin, admin_params)
