defmodule TrialGroupWeb.AdminAuthTest do
  use TrialGroupWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias TrialGroup.Administration
  alias TrialGroupWeb.AdminAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TrialGroupWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TrialGroupWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "on_mount :ensure_authenticated" do
    ...
    test "redirects to login page if there isn't a valid admin_token", %{conn: conn} do
      ...
      socket = %LiveView.Socket{
        endpoint: TrialGroupWeb.Endpoint,
